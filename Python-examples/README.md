<!-- This Readme.md file highlights the difference between Python and Javascript as a programming language and the important features of Python as a programming Language -->
